...
#[doc = "Register `data_enable` writer"]
pub struct W(crate::W<DATA_ENABLE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA_ENABLE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA_ENABLE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA_ENABLE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [data_enable::W](W) writer structure"]
impl crate::Writable for DATA_ENABLE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets data_enable to value 0xffff"]
