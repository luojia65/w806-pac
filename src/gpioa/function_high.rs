...
#[doc = "Register `function_high` writer"]
pub struct W(crate::W<FUNCTION_HIGH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FUNCTION_HIGH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FUNCTION_HIGH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FUNCTION_HIGH_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Fields `pin(0-15)` reader - Alternate function high bit."]
...
#[doc = "Fields `pin(0-15)` writer - Alternate function high bit."]
pub struct PIN_W<'a> {
    w: &'a mut W,
    offset: usize,
}
...
#[doc = "Fields `pin(0-15)` const generic writer - Alternate function high bit."]
...
#[doc = "`write(|w| ..)` method takes [function_high::W](W) writer structure"]
impl crate::Writable for FUNCTION_HIGH_SPEC {
    type Writer = W;
}
