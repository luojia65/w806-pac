...
#[doc = "Register `pull_up` writer"]
pub struct W(crate::W<PULL_UP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PULL_UP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PULL_UP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PULL_UP_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Internal pull up enable mask\n\nWrite 0 to enable.\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN_A {
    #[doc = "0: Internal pull up enabled."]
    ENABLE = 0,
    #[doc = "1: Internal pull up disabled."]
    DISABLE = 1,
}
...
#[doc = "Fields `pin(0-15)` reader - Internal pull up enable mask\n\nWrite 0 to enable."]
...
#[doc = "Fields `pin(0-15)` writer - Internal pull up enable mask\n\nWrite 0 to enable."]
pub struct PIN_W<'a> {
    w: &'a mut W,
    offset: usize,
}
impl<'a> PIN_W<'a> {
    ...
    #[doc = "Internal pull up enabled."]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(PIN_A::ENABLE)
    }
    #[doc = "Internal pull up disabled."]
    #[inline(always)]
...
#[doc = "Fields `pin(0-15)` const generic writer - Internal pull up enable mask\n\nWrite 0 to enable."]
...
#[doc = "`write(|w| ..)` method takes [pull_up::W](W) writer structure"]
impl crate::Writable for PULL_UP_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets pull_up to value 0xffff"]
