...
#[doc = "Register `trigger_mode` writer"]
pub struct W(crate::W<TRIGGER_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRIGGER_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRIGGER_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRIGGER_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fields `pin(0-15)` reader - Interrupt trigger mode selection"]
...
#[doc = "Fields `pin(0-15)` writer - Interrupt trigger mode selection"]
pub struct PIN_W<'a> {
    w: &'a mut W,
    offset: usize,
}
impl<'a> PIN_W<'a> {
    ...
    pub fn edge(self) -> &'a mut W {
        self.variant(PIN_A::EDGE)
    }
    #[doc = "Level trigger."]
    #[inline(always)]
    pub fn level(self) -> &'a mut W {
        self.variant(PIN_A::LEVEL)
    }
...
#[doc = "Fields `pin(0-15)` const generic writer - Interrupt trigger mode selection"]
...
#[doc = "`write(|w| ..)` method takes [trigger_mode::W](W) writer structure"]
impl crate::Writable for TRIGGER_MODE_SPEC {
    type Writer = W;
}
